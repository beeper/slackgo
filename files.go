...
func (api *Client) UploadFile(params UploadFileParameters) (*File, error) {
...
func (api *Client) UploadFileContext(ctx context.Context, params UploadFileParameters) (file *File, err error) {
	if params.Filename == "" {
